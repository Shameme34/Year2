...
Square::Square(string name, bool containsWarpSpace, struct Coords*node)
:ShapeTwoD(name, containsWarpSpace)
{
    Square::node = node;
}

/* Method to add Coords to Square */
void Square::addCoords()
{   
...
double Square::computeArea()
{
    ...
    /* Area of the square */
    double area = (largestx - smallestx)*(largestx - smallestx);
    return area ;
}
...
bool Square::isPointInShape(int x, int y)
{
    ...
    /* To check if the coords are in the boundaries of the square */
